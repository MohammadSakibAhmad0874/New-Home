/*
 * Configuration File — Device SH-002
...
const char* HOTSPOT_SSID = "SmartHome_SH002";
...
const char* DEVICE_ID = "SH-002";           // Must match DB
const char* DEVICE_API_KEY = "XMoihb4cNNKAc6PDJMPZIaUhNo_2nfXZ7bp9jL77G8M"; // From POST /devices/
